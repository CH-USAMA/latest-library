                                            ...
                                            <td class="align-middle ps-3">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <div class="text-dark fw-bold d-block">{{$book['title']}}</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="align-middle">
                                                <div class="text-dark fw-bold d-block">{{$book['author']}}</div>
                                            </td>
                                            <td class="align-middle">
                                                <div class="text-dark fw-bold d-block">{{$book['or_level']}}</div>
                                            </td>
                                            <td class="align-middle text-end pe-3">
                                                <a href="{{route('assignmentform',['id'=>$book['id']])}}"class="btn btn-light-primary btn-icon h-35px w-35px">
