                            ...
                            <div class="card-body py-9">
                                ...
                                <div class="row gx-9 h-100">
                                    ...
                                    <div class="col-sm-6 mb-10 mb-sm-0">
                                        <!--begin::Image-->
                                        <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-400px min-h-sm-100 h-100" style="background-size: 100% 100%;background-image:url('assets/media/Frame1.png')"></div>
                                        <!--end::Image-->
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                                            ...
                                            <div class="mb-7">
                                                ...
                                                <div class="d-flex flex-stack mb-6">
                                                    ...
                                                    <div class="flex-shrink-0 me-5">
                                                        ...
                                                        <span class="text-gray-800 fs-1 fw-bold">Book Name</span>
                                                    </div>
                                                    <!--end::Title-->
                                            ...
                                            <div class="mb-6">
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="border border-gray-300 border-dashed rounded min-w-100px w-100 py-2 px-4 me-6 mb-3">
                                                        ...
                                                        <!--end::Date-->
                                                        <!--begin::Label-->
                                                        <div class="fw-semibold text-gray-500">Published On</div>
                                                        <!--end::Label-->
                                                    </div>
                                                    <!--end::Stat-->
                                                    <!--begin::Stat-->
