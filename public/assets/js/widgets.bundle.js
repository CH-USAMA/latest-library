        ...
        t = function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    console.log(response.series); // Populate dynamically
                    console.log(response.categories); // Populate dynamically

                    var seriesData = response.series;
                    var categoriesData = response.categories;
                    // Call function to initialize chart with data
                    // initChart(response.series, response.categories);
                    var t = document.getElementById(
                        "kt_charts_widget_18_chart"
                    );
                    if (t) {
                        var a = parseInt(KTUtil.css(t, "height")),
